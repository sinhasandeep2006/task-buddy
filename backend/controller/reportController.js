...
// @desc   Get the task report
// @route  get /api/reports/export/tasks
// @access private -> admin
export const exportTaskReoport = async (req, res) => {
  try {
    ...
    // Add task rows with formatted assignedTo field
    tasks.forEach((task) => {
...
// @access Private -> Admin
export const exportUserReoport = async (req, res) => {
  try {
